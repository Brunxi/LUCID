        ...
        for hit, nr_hits in hit_overview[:5]:
            ...
            for data in query:
                if hit == data['hit_name']:
                    all_sirna_plot.extend(list(range(int(data['sirna_position']) + 1, int(data['sirna_position']) + self.sirna_size + 1)))
                    if data['is_efficient']:
                        eff_sirna_plot.extend(list(range(int(data['sirna_position']) + 1, int(data['sirna_position']) + self.sirna_size + 1)))
